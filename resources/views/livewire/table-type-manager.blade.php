<div class="space-y-6">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        <h1 class="text-2xl font-bold text-slate-900 mb-4">🪑 Masa Tipleri</h1>
        <p class="text-sm text-slate-600 mb-4">Bir masaya kaç çiçek girdiğini tanımla. Sipariş girerken masa sayısı ile otomatik çarpılır.</p>

        <form wire:submit="save" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                <div class="md:col-span-4">
                    <label class="block text-xs font-semibold text-slate-600 mb-1">Masa Tipi Adı *</label>
                    <input type="text" wire:model="name" class="w-full rounded-lg border-slate-300 focus:border-brand-500 focus:ring-brand-500" placeholder="örn. Standart Masa - 1 Sünger">
            ...
            <div class="border border-slate-200 rounded-xl p-4 bg-slate-50">
                <div class="flex items-center justify-between mb-3">
                    <h3 class="font-semibold text-slate-700">Bir Masada Kullanılacak Çiçekler</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        @empty
            <div class="md:col-span-3 text-center text-slate-400 py-8">Henüz masa tipi yok.</div>
        @endforelse
    </div>
</div>
